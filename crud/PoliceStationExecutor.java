...
String cases = ref.getCaseByName("Theft");
System.out.println("Case name is available");

ref.updateCase("Robbery", "Bank Robbery");
System.out.println("Case name is updated");	
